...
)
{
	...
	case DLL_PROCESS_ATTACH:
	{
		...
		else
		{
			...
			if(pf_MaSound_Initialize == NULL ||
				pf_MaSound_Create == NULL ||
				pf_MaSound_Load == NULL ||
				pf_MaSound_Open == NULL ||
				pf_MaSound_Control == NULL ||
				pf_MaSound_Standby == NULL ||
				pf_MaSound_Start == NULL ||
				pf_MaSound_Stop == NULL ||
				pf_MaSound_Close == NULL ||
				pf_MaSound_Unload == NULL ||
				pf_MaSound_Delete == NULL ||
				pf_Phrase_Terminate == NULL ||
				pf_MaSound_End == NULL)
			{
				return FALSE;
			}
